        ...
        <div v-if="reportes.length > 0" class="flex flex-col items-center gap-4 mt-6">
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="flex gap-1">
                    <button v-for="page in pageNumbers" :key="page" @click="handlePageClick(page)"
                        :disabled="page === '...'" :class="[
            ...
            <div class="flex items-center gap-4 text-sm text-gray-600">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <select :value="itemsPerPage" @change="$emit('updateItemsPerPage', parseInt($event.target.value))"
